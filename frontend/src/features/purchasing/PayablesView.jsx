...
export default function PayablesView({ currentUser, selectedEntity }) {
  ...
  return (
    <div data-testid="payables-view">
      {error && <div className="notice-bar danger" data-testid="payables-error"><span>{error}</span><button onClick={() => setError("")}>×</button></div>}
      ...
      <div className="section-card mb-3">
        ...
        <div className="overflow-hidden">
          {loading ? (
            ...
            <div className="py-10 text-center text-[12px] text-[#6B6B73]">Tidak ada hutang outstanding. 🎉</div>
          ) : (
