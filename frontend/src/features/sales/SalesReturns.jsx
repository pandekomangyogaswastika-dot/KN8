...
export default function SalesReturns({ currentUser }) {
  ...
  async function load() {
    ...
    try {
      ...
      const res = await axios.get(`${API}/api/sales-returns`, {
  ...
  async function loadOrders() {
    try {
      const res = await axios.get(`${API}/api/sales-orders`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  async function handleApprove(ret) {
    try {
      const res = await axios.post(
        `${API}/api/sales-returns/${ret.id}/approve`,
        { notes: "" },
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  async function handleReject(ret, reason) {
    try {
      const res = await axios.post(
        `${API}/api/sales-returns/${ret.id}/reject`,
        { notes: reason },
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  async function handleSubmit(ret) {
    try {
      const res = await axios.post(
        `${API}/api/sales-returns/${ret.id}/submit`,
        {},
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  return (
    <div data-testid="sales-returns-view" className="view-container">
      ...
      {error && (
        <div className="notice-bar danger" data-testid="return-error">
